export function fourCCToInt32 (value: string): number {
...
export enum D3DFMT
{
    ...
    ETC = fourCCToInt32('ETC '),
    ETC1 = fourCCToInt32('ETC1'),
    ATC = fourCCToInt32('ATC '),
    ATCA = fourCCToInt32('ATCA'),
    ATCI = fourCCToInt32('ATCI'),
    POWERVR_2BPP = fourCCToInt32('PTC2'),
    POWERVR_4BPP = fourCCToInt32('PTC4'),
